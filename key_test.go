...
func (s *KeyVaSuite) TestKeys(c *C) {
	...
	keys := kv.Keys()
	keys.Sort()
	c.Assert(keys[0].Key.String(), Equals, "0033F3A564EA5A6A5DA1CA4C13DE4243081771717FFFB0D81CF7ACC75652063F")
	c.Assert(keys[99].Key.String(), Equals, "FE86CD86639D2F85490FD133A482D836FE523BE36C2BF7B3A387C426B9A5171A")
